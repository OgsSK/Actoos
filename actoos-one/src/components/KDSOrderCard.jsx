...
import { Clock, AlertTriangle, Banknote, Smartphone, Check } from 'lucide-react';
...
export function KDSOrderCard({ order, onMarkReady, isReady = false }) {
  ...
  return (
    ...
    >
      {/* Bannière instructions spéciales */}
      {hasSpecialInstructions && !isReady && (
        <div 
          ...
          <div key={index} className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              {item.special_instructions && (
                <div className="mt-1 bg-red-50 border border-red-200 rounded-lg px-3 py-2">
      ...
      {!isReady && (
        <div className="p-4">
          <button
            onClick={onMarkReady}
            className="w-full bg-primary text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-2 active:bg-primary/80 transition-colors text-lg"
