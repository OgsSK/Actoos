...
const ActoosCorporate = () => {
  const [mobileMenuOpen, setMobileMenuOpen] = React.useState(false);

  return (
    <div className="min-h-screen bg-[#FFFFFF] font-sans text-slate-900 selection:bg-orange-100">
      ...
      <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-xl z-50 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          ...
          <button className="hidden md:block bg-slate-950 text-white px-8 py-3 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-[#D4AF37] transition-all shadow-2xl hover:shadow-yellow-500/20">
            Global Portal
          </button>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-slate-100 px-6 py-4 space-y-4">
            ...
            <button className="w-full bg-slate-950 text-white px-6 py-3 rounded-full text-xs font-black uppercase tracking-widest">
              Global Portal
            </button>
          </div>
        )}
      ...
      <header className="pt-32 md:pt-48 pb-20 md:pb-32 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-[900] tracking-tighter leading-[0.9] mb-8 md:mb-12 text-slate-950">
      ...
      <section id="products" className="py-16 md:py-32 px-4">
        <div className="max-w-7xl mx-auto bg-[#0F172A] rounded-[32px] md:rounded-[64px] p-6 md:p-12 lg:p-20 relative overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)]">
          ...
          <div className="absolute top-[-100px] right-[-100px] w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-[#D4AF37]/10 blur-[150px] rounded-full"></div>
          <div className="absolute bottom-[-50px] left-[-50px] w-[200px] md:w-[300px] h-[200px] md:h-[300px] bg-[#10B981]/5 blur-[100px] rounded-full"></div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            <div className="relative">
              <div className="bg-slate-50 rounded-[32px] md:rounded-[48px] p-8 md:p-12 relative overflow-hidden">
                <img 
                  src="/corporate/logo-actoos-slogan.png" 
      ...
      <footer className="bg-white py-16 md:py-20 px-6 border-t border-slate-100">
        ...
        <div className="max-w-7xl mx-auto mt-16 md:mt-20 pt-8 border-t border-slate-50 flex flex-col sm:flex-row justify-between items-center gap-4 text-[9px] font-black uppercase tracking-[0.3em] text-slate-300">
          ...
          <div className="flex space-x-8">
            <a href="/privacy" className="hover:text-black cursor-pointer">Privacy</a>
            <a href="/legal" className="hover:text-black cursor-pointer">Legal</a>
          </div>
        </div>
      </footer>
...
export default ActoosCorporate;
