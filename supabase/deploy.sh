...
echo "   supabase secrets set TWILIO_ACCOUNT_SID=your_twilio_sid"
echo "   supabase secrets set TWILIO_AUTH_TOKEN=your_twilio_token"
echo "   supabase secrets set TWILIO_PHONE_NUMBER=your_twilio_phone"
