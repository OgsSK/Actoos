...
import {
  ...
  Building2, UserCircle, ClipboardList, Wrench, CalendarDays, BarChart3, PieChart, FileSpreadsheet, Code, Download, Crown, MessageCircle, Upload, KanbanSquare, MapPin, BookOpen
} from 'lucide-react';
...
const Sidebar = ({ open, onClose, onShowInstallGuide }) => {
  ...
  const navItems = [
    ...
    { icon: MapPin, label: 'Carte GPS', path: '/dashboard/map', admin: true },
    ...
    { icon: BookOpen, label: 'Catalogue', path: '/dashboard/pricebook', admin: true },
          ...
          <div className="p-4 border-b border-slate-800">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <img src="/logo-icon-site.png" alt="ACTOOS PRO" className="w-10 h-10 rounded-xl object-contain" />
                <div>
