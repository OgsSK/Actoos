      ...
      <main className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-slate-500 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            ...
            Nous transformons des idées en solutions numériques performantes depuis 2026.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto mb-20">
          ...
          <div className="bg-slate-50 rounded-[32px] p-8 md:p-12">
            <div className="space-y-6 text-slate-600 leading-relaxed">
              <p>
                Actoos a été fondé en 2026 par Salif KANE, ingénieur logiciel passionné par la création de solutions technologiques accessibles et performantes.
              </p>
              <p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <div className="bg-white rounded-[32px] p-8 shadow-xl border border-slate-100 max-w-sm">
              ...
              <h3 className="font-bold text-xl mb-1">Salif KANE</h3>
              <p className="text-slate-500 text-sm">Fondateur & Ingénieur Logiciel</p>
            </div>
          </div>
